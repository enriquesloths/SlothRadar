...
// void in(PIXELM *pixel, int image_width, int image_height) {
//   int i, j;
//   for (i=0; i < image_height; i++) {
//     for (j=0; j < image_width; j++) {
//       PIXELM *pixel_pointer = pixel;
	...
	int wrap_around_x, int wrap_around_y)
{
  ...
  // double** wrapped_image = (double**)malloc(image_height * sizeof(double*));
  // for (int i = 0; i < image_height; i++) {
  //   wrapped_image[i] = (double*)malloc(image_width * sizeof(double));
  // }
  ...
  //     wrapped_image[i][j] = wrappedimage[index];
  //   }
  // }
  ...
  // in(pixel, image_width, image_height);

  // for (int i = 0; i < image_height; ++i) {
  //   UnwrappedImage[i] = image_height;
  // }
...
// void addArraysInt32 (float *array1, float* array2, float* result, int length)
// {
...
//   unwrap2D(velocities, final, mask, width, height, 0, 0);
